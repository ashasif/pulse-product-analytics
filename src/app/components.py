...
def numeric_series(frame: pd.DataFrame, columns: list[str]) -> pd.DataFrame:
...
def first_row(frame: pd.DataFrame) -> Mapping[str, Any]:
...
def render_lineage(context: Mapping[str, Any]) -> None:
    st.sidebar.caption(
